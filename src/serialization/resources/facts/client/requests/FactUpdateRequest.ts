...
export const FactUpdateRequest: core.serialization.Schema<serializers.FactUpdateRequest.Raw, Corti.FactUpdateRequest> =
...
export declare namespace FactUpdateRequest {
