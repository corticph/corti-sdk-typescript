...
export const ResponseFactGroupsFilteredDataItemTranslationsItem: core.serialization.ObjectSchema<
    serializers.ResponseFactGroupsFilteredDataItemTranslationsItem.Raw,
