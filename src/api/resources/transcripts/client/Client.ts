...
export class Transcripts {
    ...
    ): core.HttpResponsePromise<Corti.ResponseTranscriptListAll> {
     ...
     * @param {Corti.RequestTranscriptCreate} request
     * @param {Transcripts.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Corti.BadRequestError}
     * @throws {@link Corti.UnauthorizedError}
    ...
    private async __createTranscript(
        ...
        const _response = await core.fetcher({
            ...
            requestType: "json",
            body: serializers.RequestTranscriptCreate.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
                omitUndefined: true,
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
