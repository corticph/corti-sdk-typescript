...
export const TranscribeConfigTranscriptProcessing = {
    Standard: "standard",
    Raw: "raw",
} as const;
export type TranscribeConfigTranscriptProcessing =
    (typeof TranscribeConfigTranscriptProcessing)[keyof typeof TranscribeConfigTranscriptProcessing];
