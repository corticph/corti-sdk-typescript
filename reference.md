...
<details><summary><code>client.interactions.<a href="/src/api/resources/interactions/client/Client.ts">listAllInteractions</a>({ ...params }) -> core.Page<Corti.ResponseInteractionsInteractionsItem></code></summary>
<dl>
<dd>
...
const page = await client.interactions.listAllInteractions();
...
<details><summary><code>client.interactions.<a href="/src/api/resources/interactions/client/Client.ts">createInteraction</a>({ ...params }) -> Corti.ResponseInteractionCreate</code></summary>
<dl>
<dd>
...
<details><summary><code>client.interactions.<a href="/src/api/resources/interactions/client/Client.ts">getExistingInteraction</a>(id) -> Corti.ResponseInteraction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.interactions.<a href="/src/api/resources/interactions/client/Client.ts">updateInteraction</a>(id, { ...params }) -> Corti.ResponseInteraction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.recordings.<a href="/src/api/resources/recordings/client/Client.ts">listRecordings</a>(id) -> Corti.ResponseRecordingList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.recordings.<a href="/src/api/resources/recordings/client/Client.ts">getRecording</a>(id, recordingId) -> string</code></summary>
<dl>
<dd>
...
**id:** `string` — The unique identifier of the interaction for which the recording should be retrieved. Must be a valid UUID.
...
**recordingId:** `string` — The unique identifier of the recording to be retrieved. Must be a valid UUID.
...
<details><summary><code>client.transcripts.<a href="/src/api/resources/transcripts/client/Client.ts">listTranscripts</a>(id, { ...params }) -> Corti.ResponseTranscriptListAll</code></summary>
<dl>
<dd>
...
<details><summary><code>client.transcripts.<a href="/src/api/resources/transcripts/client/Client.ts">createTranscript</a>(id, { ...params }) -> Corti.ResponseTranscriptCreate</code></summary>
<dl>
<dd>
...
<details><summary><code>client.transcripts.<a href="/src/api/resources/transcripts/client/Client.ts">getTranscript</a>(id, transcriptId) -> Corti.ResponseTranscriptCreate</code></summary>
<dl>
<dd>
...
<details><summary><code>client.documents.<a href="/src/api/resources/documents/client/Client.ts">listDocuments</a>(id) -> Corti.ResponseDocumentList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.documents.<a href="/src/api/resources/documents/client/Client.ts">generateDocument</a>(id, { ...params }) -> Corti.ResponseDocumentRead</code></summary>
<dl>
<dd>
...
<details><summary><code>client.documents.<a href="/src/api/resources/documents/client/Client.ts">getDocument</a>(id, documentId, { ...params }) -> Corti.ResponseDocumentRead</code></summary>
<dl>
<dd>
...
<details><summary><code>client.documents.<a href="/src/api/resources/documents/client/Client.ts">updateDocument</a>(id, documentId, { ...params }) -> Corti.ResponseDocumentRead</code></summary>
<dl>
<dd>
